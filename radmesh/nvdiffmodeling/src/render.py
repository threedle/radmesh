...
# namanh HACK:
import os
NVDMHACK_XFMPOINTS_USE_PYTHON = bool(os.environ.get("NVDMHACK_XFMPOINTS_USE_PYTHON"))
# end namanh HACK
...
def render_mesh(
    ...
    v_pos_clip = ru.xfm_points(mesh.v_pos[None, ...], mtx_in, use_python=NVDMHACK_XFMPOINTS_USE_PYTHON)
